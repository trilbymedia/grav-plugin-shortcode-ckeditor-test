...
class ShortcodeNextGenEditorPlugin extends Plugin
{
    ...
    public function onPluginsInitialized()
    {
        ...
        if (!$this->config->get('plugins.shortcode-nextgen-editor.active_admin') && $this->isAdmin()) {
            return;
        }
    ...
    {
        $include_default_shortcodes = $this->config->get('plugins.shortcode-nextgen-editor.include_default_shortcodes', true);
        ...
        $custom_shortcodes = $this->config->get('plugins.shortcode-nextgen-editor.custom_shortcodes');
    ...
    public function registerNextGenEditorPluginShortcodes($event) {
        ...
        $this->registerNextGenEditorPluginShortcodesCore($plugins);
        $this->registerNextGenEditorPluginShortcodesUI($plugins);

        $this->registerNextGenEditorPluginShortcodesAdyen($plugins);
